...
import { TodosModule as service } from './todos.module';
import { CONFIG } from './config';

// then create the service module
/**
 *  [Backend] Todos Node Server Microservices
 *  Follow steps 0 to final to know how it work
 */
/** step 0: start processing with comments */
console.log('[INFO]: --- Todos Node Server Microservice ---', CONFIG.serverConfig.verbose);
